...
from evaluation.eval_extrinsic import evaluation
...
#python main/train_extrinsic.py --object_name=any_train --exp=any_kind --object_cat=any_kind --robot=xarm7_gripper_down --task_index=2 --use_tactile=True --use_rgb=False --use_depth=True --train_time=0517 --seed=500

#main/train_extrinsic.py --object_name=any_train --exp=kitchen --object_cat=kitchen --robot=xarm7_gripper_down
#main/train_extrinsic.py --object_name=00 --exp=assembling_kits --object_cat=assembling_kits --robot=xarm7_gripper_down
#main/train_extrinsic.py --object_name=any_train --exp=spoon --object_cat=spoon --robot=xarm7_gripper_down
#main/train_extrinsic.py --object_name=any_train --exp=pen --object_cat=pen --robot=xarm7_gripper_down
#main/train_extrinsic.py --object_name=any_train --exp=all_kind --object_cat=all_kind --robot=xarm7_gripper_down
#main/train_extrinsic.py --object_name=any_train --exp=USB --object_cat=USB --robot=xarm7_gripper_down
#main/train_extrinsic.py --object_name=any_train --exp=02946921_extrinsic --object_cat=02946921 --robot=xarm7_gripper_down  --use_tactile=True --use_rgb=False --use_mask=True

#main/train_extrinsic.py --object_name=any_train --exp=all_kind --object_cat=all_kind --robot=xarm7_gripper_down  --task_index=2 --use_tactile=True --use_rgb=False --crop=True --use_mask=True --use_pc=True --noise_pc=True
if __name__ == '__main__':
    ...
    parser.add_argument('--train_time', default="0708", type=str)
