...
from evaluation.eval_insertion import evaluation
...
#main/train_insertion.py --object_name=any_train --exp=USB --object_cat=USB --robot=xarm7_gripper_front --use_tactile=True --use_rgb=False --use_mask=True --crop=True
#main/train_insertion.py --object_name=any_train --exp=pen --object_cat=pen --robot=xarm7_gripper_front --use_tactile=True --use_rgb=False --use_mask=True --crop=True
if __name__ == '__main__':
    ...
    parser.add_argument('--robot', default="xarm6_allegro_sfr_front", type=str)
    ...
    parser.add_argument('--train_time', default="0526", type=str)
    ...
    parser.add_argument('--NatureCNN', default=True, type=str2bool)
    ...
    if args.use_tactile:
        if args.crop:
            ...
            exp_keywords = [
                "ppo", args.object_name, exp, "insertion", "tactile_crop",
                str(args.seed)
            ]
        else:

            exp_keywords = [
                "ppo", args.object_name, exp, "insertion", "tactile",
                str(args.seed)
            ]
    else:

        exp_keywords = [
            "ppo", args.object_name, exp, "insertion",
            str(args.seed)
        ]
    ...
    def create_env_fn():
        environment = create_insertion_env(
            object_name=args.object_name,
            ...
            low_friction=args.low_friction,
