...
class PartialKinematicModel:
    ...
    def __init__(self, robot: sapien.Articulation, start_joint_name: str,
                 end_joint_name: str):
        ...
        for j_idx, j in enumerate(all_joints):
            ...
            link.set_joint_properties(j.type, j.get_limits(),
                                      j.get_pose_in_parent(),
                                      j.get_pose_in_child())
        ...
        self.end_link_index = [
            i for i, link in enumerate(partial_robot.get_links())
