...
def build_free_root(robot_builder: sapien.ArticulationBuilder,
                    robot_name="",
    ...
    for i in range(6):
        ...
        if i == 3 or i == 0:
            child.set_joint_properties(joint_types[i],
...
def build_ball_joint(robot_builder: sapien.ArticulationBuilder,
                     parent: sapien.LinkBuilder, name: str,
    ...
    for i in range(3):
        ...
        link.set_joint_properties("revolute",
                                  limits=joint_limit,
...
def rot_from_connected_link(pos_parent,
                            pos_child,
...
def create_visual_material(renderer: sapien.VulkanRenderer, specular, metallic,
                           roughness, base_color):
    if renderer is None:
        return None
