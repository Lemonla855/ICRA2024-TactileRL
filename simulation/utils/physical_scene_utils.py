...
def is_link_group_contact(scene: sapien.Scene, actors1: List[sapien.Actor],
                          actors2: List[sapien.Actor]) -> bool:
    ...
    for contact in scene.get_contacts():
        ...
        if len(actor_set1 & contact_actors) > 0 and len(actor_set2
                                                        & contact_actors) > 0:
