...
class PPO(OnPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        self.CURL = CURL(self.features_dim, self.batch_size,
                         ...
                         self.target_features_extractor).to(self.device)

        self.target_features_extractor.load_state_dict(
            self.policy.features_extractor.state_dict())

        self.curl_optimizer = th.optim.Adam(self.CURL.parameters(),
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                curl_loss = self.get_curl_loss(
                    ...
                    rollout_data.next_observations[1])
                ...
                soft_update_params(self.policy.features_extractor,
