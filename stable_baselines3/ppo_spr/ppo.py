...
class SPR(nn.Module):
    def __init__(self, z_dim, a_dim, encoder, encoder_target, tau=0.005):
        ...
        self.dynamics = nn.Sequential(*create_mlp(
            input_dim=z_dim + a_dim, output_dim=z_dim, net_arch=[256, 256]))
...
class PPO(OnPolicyAlgorithm):
    ...
    def __init__(self,
        ...
        self.kl_scheduler = AdaptiveScheduler(kl_threshold=target_kl,
                                              min_lr=min_lr,
                                              max_lr=max_lr,
    ...
    def _setup_model(self) -> None:
        ...
        buffer_cls = DictSSLRolloutBuffer if isinstance(
        ...
        features_extractor_class = self.policy_kwargs[
        ...
        self.SPR = SPR(self.features_dim,
                       get_action_dim(self.action_space),
                       self.policy.features_extractor,
                       self.target_features_extractor,
                       tau=self.encoder_tau).to(self.device)

        self.spr_optimizer = th.optim.Adam(self.SPR.parameters(),
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                spr_loss = self.SPR.get_spr_loss(
                    rollout_data.observations, rollout_data.next_actions[0:3],
