...
class VecTransposeImage(VecEnvWrapper):
        ...
        if isinstance(venv.observation_space, spaces.dict.Dict):
            ...
            for key, space in observation_space.spaces.items():
                if is_image_space(space):
                    ...
                    observation_space.spaces[key] = self.transpose_space(
                        space, key)
        else:
    ...
    @staticmethod
    def transpose_space(observation_space: spaces.Box,
                        key: str = "") -> spaces.Box:
        """
    ...
    def transpose_observations(
            self, observations: Union[np.ndarray,
                                      Dict]) -> Union[np.ndarray, Dict]:
        """
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        for idx, done in enumerate(dones):
            ...
            if "terminal_observation" in infos[idx]:
                infos[idx][
                    "terminal_observation"] = self.transpose_observations(
