...
class Image:
    ...
    """
    def __init__(self, image: Union[th.Tensor, np.ndarray, str],
                 dataformats: str):
        self.image = image
...
class HumanOutputFormat(KVWriter, SeqWriter):
    ...
    """
    def __init__(self,
                 filename_or_file: Union[str, TextIO],
                 max_length: int = 36):
    ...
    def write(self,
        ...
        for i, key in enumerate(self.keys):
            ...
            if isinstance(value, Video):
                ...
                value = value.replace(self.quotechar,
                                      self.quotechar + self.quotechar)
...
def configure(folder: Optional[str] = None,
              format_strings: Optional[List[str]] = None) -> Logger:
    """
