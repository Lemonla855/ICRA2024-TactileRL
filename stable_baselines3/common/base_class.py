...
def set_pretrain_parameters(
    ...
    objects_needing_update = set(model._get_torch_save_params()[0])
    updated_objects = set()
    ...
    for name in params:
        ...
        if isinstance(attr, th.optim.Optimizer):
            ...
            attr.param_groups[0]['capturable'] = True
        else:
...
def pretrain_load(
    pretrained_path: Union[str, pathlib.Path, io.BufferedIOBase],
    device: Union[th.device, str] = "auto",
    ...
    **kwargs,
    ...
    set_pretrain_parameters(pretrain_model,
                            load_path_or_dict=params,
                            exact_match=True,
                            device=device)
