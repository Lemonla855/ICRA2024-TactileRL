...
if __name__ == '__main__':
    ...
    parser.add_argument('--object_cat', type=str, default="pen")
    parser.add_argument('--train_time', type=str, default="0718")
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        "ppo_stable-any_train-0-pen_multi_buffer_noise_righthanddown-500")
    parser.add_argument('--itr', type=int, default="420")
    ...
    while not viewer.closed:
        ...
        if abs(info["height_devitation"]) < 0.01 and info["contact"] and abs(
                info["contact_angles"]) < 5:
        ...
        print(f"Reward: {reward_sum}", [
            env.first_theta, env.target_angles, info["contact_angles"],
            env.error_percentage
        ], info["height_devitation"], success / total)
